  ...
  return (
    <div className='Main'>
      <div className='FlightSearch w-full max-w-[1280px] bg-white px-8 py-4 m-auto'>
        <div className='h-7 flex justify-between gap-3 items-center'>
                  ...
                  <div className="grid grid-cols-2 gap-4 CustomerInfo_input-group__U1xTl">
                    ...
                    <div className=" ">
                      <label for=":r20:" className="InputModal">
                        <input id=":r20:" className="p-md" placeholder="Nhập điện thoại" value={city} onChange={(e) => setCity(e.target.value)} onFocus={handleFocus} />
