                            ...
                            <div className='flex items-center justify-between'>
                                <div className='w-[49.3%]'>
                                    <label className='input_group'>
                                        ...
                                        <input type="text" placeholder="Vui lòng nhập điểm đi" className="rounded-[28px] outline-none text-slate-700 w-full h-6 pl-1" />
                                ...
                                <div className='w-[49.3%]'>
                                    <label className='input_group'>
                                        ...
                                        <input type="text" placeholder="Vui lòng nhập điểm đến" className="rounded-[28px] outline-none text-slate-700 w-full h-6 pl-1" />
                            ...
                            <div className='flex items-center justify-between relative'>
                                <div className='w-[49.3%]'>
                                    <label className='input_group'>
                                        ...
                                        <input type="date" className="rounded-[28px] outline-none w-full custom-date-input text-slate-700" />
                                    </label>
                                </div>
                                <div className='w-[49.3%]'>
                                    <label className='input_group'>
