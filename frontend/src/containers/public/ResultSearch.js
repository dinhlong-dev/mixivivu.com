...
const ResultSeach = () => {
  ...
  const [adultInfo, setAdultInfo] = useState([
    { gender: '', firstName: '', lastName: '', dob: '', idCard: '', idExpiry: '' },
  ]);
  ...
  const handleGenderSelect = (index, gender, type) => {
    console.log("Selected gender:", gender);  // Kiểm tra giới tính đã chọn

    if (type === 'adult') {
      setSelectedGenderAdult(prevState => {
        const updatedGender = [...prevState];  // Sao chép mảng cũ để không thay đổi trực tiếp mảng
        updatedGender[index] = gender;  // Cập nhật giới tính ở vị trí index
        console.log("Updated adult genders:", updatedGender);  // Log mảng giới tính người lớn
      ...
      setSelectedGenderChild(prevState => {
        ...
        console.log("Updated child genders:", updatedGender);  // Log mảng giới tính trẻ em
        return updatedGender;
      });
    } else if (type === 'infant') {
      setSelectedGenderInfant(prevState => {
        const updatedGender = [...prevState];
        updatedGender[index] = gender;
        console.log("Updated infant genders:", updatedGender);  // Log mảng giới tính trẻ sơ sinh
        return updatedGender;
      });
    }
  };
  ...
  const handleBooking = async (e) => {
    ...
    console.log('Thông tin người dùng:', contactInfo);
  }
  ...
  const handlePayments = async () => {
    try {
      ...
      const paymentInfo = {
        ...
        phone_number: '0123456789'  // Số điện thoại người dùng
      };
  ...
  // Gửi orderId tới backend để kiểm tra trạng thái thanh toán
  const checkPaymentStatus = async (orderId) => {
    try {
      const response = await axios.post('http://localhost:5000/v1/payment/transaction-status', { orderId });
              ...
              <div className='px-6 py-4 flex flex-col gap-4 flex-grow max-w-full'>
                        ...
                        <div className="grid grid-cols-2 gap-4 CustomerInfo_input-group__U1xTl">
                          <div className=" ">
                            <label for=":r1v:" className="Input_input-group__6PMfq">
                              <input type='text' name='lastName' required className="p-md" placeholder="Nhập tên đệm và tên" value={contactInfo.lastName} onChange={handleInputChangeCT} />
                        ...
                        {!email ? (
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <button onClick={handleLogout} type='button' className="Button_button__QHarr Button_button-normal__y4h10 Button_button-color-destructive__1mG3r">
                              <div class="label md">Đăng xuất</div>
                            </button>
                          </div>
                        )}
                      </div>
                ...
                {(isChooseReturn || isChooseDeparture) && (
                  <div className="flex justify-between">
                    ...
                    <button onClick={handleBooking} type="button" className="Button_button__QHarr  Button_button-normal__y4h10 Button_button-color__7QnYK" disabled="">
                              ...
                              <div className='FlightItemCard_header__fyioF p-6 cursor-pointer flex gap-4 items-center'>
                                <div className='w-full flex gap-4'>
                                  <div className='flex gap-4 items-center'>
                                    ...
                                    <div className="flex flex-col gap-2 flex-grow text-left">
                                      <label className="sm">{}</label>
                                      <p className="text-[#667085] sm">d</p>
                                    </div>
                                  </div>
                                </div>
                                <div className='w-full flex gap-4'>
                                  <div className="FlightItemCard_destination___qpoR"><label className="sm"></label><p className="sm"></p></div>
                                  <div className="FlightItemCard_destination___qpoR"><label className="sm"></label><p className="sm"></p></div>
                                </div>
                                <div className="FlightItemCard_price__yFFyH">
                                  <label className="sm"></label>
                              ...
                              <div>
                                <div className="FlightItemCard_content__eJaAQ">
                                  <div className="flex gap-[19px] flex-grow">
                                    ...
                                    <div className="flex flex-col gap-3 justify-between">
                                      <div className="flex gap-2 items-center">
                                        <label className="sm"></label>
                                        <div className="FlightItemCard_dot__Fb_rm">
                                        </div><label className="sm"></label></div>
                                      <p className="sm">Thời gian chuyến đi: {flights.flight_duration} phút</p>
                                      <div className="flex gap-2 items-center">
                                        <label className="sm"></label>
                                        <div className="FlightItemCard_dot__Fb_rm"></div>
                                  ...
                                  <div className="flex flex-col gap-2">
                                    ...
                                    <p className="sm">Hãng: </p>
                                    <p className="sm">Chuyến bay: </p>
                                    <p className="sm">Hạng chỗ: </p>
                                    <p className="sm">Máy bay: 321</p>
                                    <p className="sm">Hành lý xách tay: </p>
                                    <p className="sm">Hành lý ký gửi: </p>
                                  </div>
                                </div>
                              </div>
                            </div>
